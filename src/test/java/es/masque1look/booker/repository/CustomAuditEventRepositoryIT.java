package es.masque1look.booker.repository;

import es.masque1look.booker.BookerApp;
import es.masque1look.booker.config.Constants;
import es.masque1look.booker.config.audit.AuditEventConverter;
import es.masque1look.booker.domain.PersistentAuditEvent;
...
import static es.masque1look.booker.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
